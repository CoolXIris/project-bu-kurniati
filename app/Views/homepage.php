                ...
                <div class="space-y-4">
                    <div class="relative">
                        ...
                        <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-4 rounded-b-lg" style="width: auto;">
                            ...
                            <a href="<?= base_url('page/chipset_exynos2200') ?>">
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-4 rounded-b-lg" style="width: auto;">
                            ...
                            <a href="<?= base_url('page/vivo_x100pro') ?>">
            ...
            <div class="flex space-x-4">
                ...
                <div class="bg-gray-800 p-4 rounded-lg flex">
                    ...
                    <div class="ml-4">
                        ...
                        <a href="<?= base_url('page/diablo_iv') ?>">
                            <h2 class="text-lg font-bold">
        ...
        <div class="max-w-4xl mx-auto p-4">
            ...
            <div class="space-y-8">
                <div class="flex flex-col md:flex-row bg-gray-800 p-4 rounded-lg">
                    <div class="flex-1">
                        <a href="<?= base_url('page/permata_me') ?>">
                ...
                <div class="flex flex-col md:flex-row bg-gray-800 p-4 rounded-lg">
                    <div class="flex-1">
                        <a href="<?= base_url('page/oppo_campus') ?>">
                            <h2 class="text-xl font-bold mb-2">
                ...
                <div class="flex flex-col md:flex-row bg-gray-800 p-4 rounded-lg">
                    <div class="flex-1">
                        <a href="<?= base_url('page/inflection_ai') ?>">
                            <h2 class="text-xl font-bold mb-2">
                    ...
                    <div class="flex-shrink-0 md:ml-4 mt-4 md:mt-0 relative">
                        <img alt="Image of OPPO Campus Ambassador banner" class="w-full h-full object-cover rounded-lg" height="200" src="<?= base_url('css/img/Infle_ai.jpeg') ?>" width="300" style="width: 300px;height:200px" />
                        <span class="absolute bottom-2 left-2 bg-red-600 text-white text-xs font-bold px-2 py-1 rounded">
                            NEWS
                        </span>
                    </div>
                ...
                <div class="flex flex-col md:flex-row bg-gray-800 p-4 rounded-lg">
                    <div class="flex-1">
                        <a href="<?= base_url('page/tv_samsung') ?>">
                            <h2 class="text-xl font-bold mb-2">
