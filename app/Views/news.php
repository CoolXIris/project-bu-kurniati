...
<body>
    ...
    <nav class="navbar bg-body-tertiary">
        <div class="container-fluid" style="justify-content: center;">
            <!-- Navbar Brand: News -->
            <a class="navbar-brand active" href="<?= base_url('news')?>">
                News
            </a>
    ...
    <div class="about">
        <div class="text-about">
            <p style="font-size: 13px;color:white;margin-bottom:28px">GadgetGlimpse > <span style="color: #ff184e;">News</span></p>
            <h2 style="color: white; margin-bottom:25px; font-size:21px">News</h2>
            <p style="color: white;" class="about-text">menyajikan ulasan berita terbaru yang komprehensif seputar teknologi informasi dan telekomunikasi, gadget, dan sebagainya.</p>
        </div>
