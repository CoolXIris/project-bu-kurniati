...
<head>
    ...
    <title>
        Tips Rakit PC Gaming Edisi 2024
    </title>
        ...
        <div class="container mx-auto flex items-center justify-between">
            ...
            <div class="flex items-center space-x-6">
                <div class="relative group">
                    <button class="focus:outline-none" href="<?= base_url('news') ?>">NEWS</button>
                ...
                <div class="relative group">
                    <button class="focus:outline-none" href="<?= base_url('review') ?>">REVIEW</button>
                    <div class="absolute hidden group-hover:block bg-gray-800 text-white mt-2 py-2 w-48">
                        <a href="#" class="block px-4 py-2">Submenu 1</a>
                        <a href="#" class="block px-4 py-2">Submenu 2</a>
                    </div>
                ...
                <div class="relative group">
                    <button class="focus:outline-none">GADGET</button>
                    <div class="absolute hidden group-hover:block bg-gray-800 text-white mt-2 py-2 w-48">
                        <a href="#" class="block px-4 py-2">Submenu 1</a>
                        <a href="#" class="block px-4 py-2">Submenu 2</a>
                    </div>
                ...
                <div class="relative group">
                    <button class="focus:outline-none">COMPUTER</button>
                    <div class="absolute hidden group-hover:block bg-gray-800 text-white mt-2 py-2 w-48">
                        <a href="#" class="block px-4 py-2">Submenu 1</a>
                        <a href="#" class="block px-4 py-2">Submenu 2</a>
                    </div>
                ...
                <div class="relative group">
                    ...
                    <div class="absolute hidden group-hover:block bg-gray-800 text-white mt-2 py-2 w-48">
                        <a href="#" class="block px-4 py-2">Rekomendasi</a>
                        <a href="#" class="block px-4 py-2">Tips</a>
                        <a href="#" class="block px-4 py-2">SpeedTest Jaringan</a>
                    </div>
                </div>
            </div>
            <div class="flex items-center space-x-4">
