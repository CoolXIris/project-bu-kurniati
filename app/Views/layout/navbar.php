<nav class="navbar bg-body-tertiary">
    <div class="container-fluid" style="justify-content: center;">
        <!-- Navbar Brand: News -->
        <a class="navbar-brand" href="<?= base_url('news') ?>" style="font-size: 20px;">
            News
        </a>
        <div class="news-preview">
            ...
            <div class="news-card-mini">
                ...
                <a href="<?= base_url('page/mediatek_dimensity9400') ?>" class="headline-mini">Chip Flagship Mediatek Dimensity 9400 Maksimalkan Performa & Efisiensi...</a>
            ...
            <div class="news-card-mini">
                ...
                <a href="<?= base_url('page/vnpt') ?>" class="headline-mini">VNPT & Qualcomm Luncurkan XGS-PON WiFi 7, Kecepatan Internet Sampai 22 Gbps...</a>
            ...
            <div class="news-card-mini">
                ...
                <a href="<?= base_url('page/lokadata') ?>" class="headline-mini">Laporan Lokadata: 73 Persen Gen Z Beralih Gunakan Bank Digital...</a>
            ...
            <div class="news-card-mini">
                ...
                <a href="<?= base_url('page/tiktok_as') ?>" class="headline-mini">Tiktok Dituntut Jaksa Agung AS, Dianggap Tak Perhatikan Kesehatan Mental...</a>
        ...
        <!-- Navbar Brand: Review -->
        <a class="navbar-brand" href="<?= base_url('review') ?>" style="font-size: 20px;">
            Review
        </a>
        <div class="news-preview">
            <div class="news-card-mini">
                ...
                <a href="<?= base_url('page/vivo_x100pro') ?>" class="headline-mini">Review vivo X100 Pro: Hadir Belakangan, Kualitas Foto Jempolan</a>
            ...
            <div class="news-card-mini">
                ...
                <a href="<?= base_url('page/oppo_reno12f') ?>" class="headline-mini">Review OPPO Reno 12F 5G: Smartphone Stylish Tahan Banting</a>
            ...
            <div class="news-card-mini">
                ...
                <a href="<?= base_url('page/gal_wtch7') ?>" class="headline-mini">Review Samsung Galaxy Watch 7: Makin Pintar dengan AI</a>
            ...
            <div class="news-card-mini">
                ...
                <a href="<?= base_url('page/realme_13pro') ?>" class="headline-mini">Review realme 13 Pro+ 5G: Ketika Algoritma AI & Sensor Sony LYTIA Bersinergi</a>
        ...
        <!-- Navbar Brand: Gadget -->
        <a class="navbar-brand" href="<?= base_url('gadget') ?>" style="font-size: 20px;">
            Gadget
        </a>
        <div class="news-preview">
            <div class="news-card-mini">
                <div class="image-container-mini">
                    <img src="<?= base_url('css/img/spec_zte.png') ?>" alt="News Image">
                    <span class="badge-bottom-left-mini">ZTE BLADE A35</span>
                </div>
                <a href="<?= base_url('page/zte_blade') ?>" class="headline-mini">Review ZTE Blade A35: Nggak Sampai Sejuta, Bawa Gimmick Menarik</a>
            ...
            <div class="news-card-mini">
                ...
                <a href="<?= base_url('page/zeiss') ?>" class="headline-mini">Mengenal Fitur ZEISS Multifocal Portrait di vivo V40, Mereplikasi Kamera Multi-lensa</a>
            ...
            <div class="news-card-mini">
                ...
                <a href="<?= base_url('page/galaxy_a16') ?>" class="headline-mini">Samsung Galaxy A16 5G Siap Meramaikan Pasar Mid-Range Tanah Air</a>
            ...
            <div class="news-card-mini">
                ...
                <a href="<?= base_url('page/smart_ring') ?>" class="headline-mini">Apple Dikabarkan Batal Kembangkan Smart Ring. Ini Alasannya</a>
        ...
        <!-- Navbar Brand: Laptop -->
        <a class="navbar-brand" href="<?= base_url('laptop') ?>" style="font-size: 20px;">
            Laptop
        </a>
        <div class="news-preview">
            <div class="news-card-mini">
                <div class="image-container-mini">
                    <img src="<?= base_url('css/img/op_yoga9i.png') ?>" alt="News Image">
                    <span class="badge-bottom-left-mini">LAPTOP</span>
                </div>
                <a href="<?= base_url('page/le_yoga9i') ?>" class="headline-mini">Review Lenovo Yoga Book 9i (2024): Laptop Dua Layar Untuk Produktivitas Maksimal</a>
                <p class="description-mini">Baru-baru ini, sebanyak 14 jaksa agung dari negara bagian Amerika Serikat telah...</p>
            </div>
        </div>
        ...
        <li class="nav-item dropdown" style="margin-bottom:18px;">
            <a class="navbar-brand dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="font-size: 20px;">
                Dropdown
            </a>
